...
The [0.4.0 report](VERIFICATION-0.4.0.md) records the earlier compiled popup Chrome preview, shared-settings migration and previous live evidence. No new full installed-playback certification is claimed for either service.
