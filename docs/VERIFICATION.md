# Informe de verificación 0.3.1

Fecha: 7 de septiembre de 2026.

## Código y build

**npm run check** completó TypeScript, 246 pruebas en nueve suites y el build MV3. El manifiesto conserva la descripción inglesa y las mismas dos plataformas y permiso storage. Créditos, siguiente episodio y lista siguen apagados inicialmente.

| Suite | Pruebas | Cobertura |
| --- | ---: | --- |
| Ajustes | 20 | Defaults, validación, migración y preferencias independientes |
| Identidad y lista | 11 | Enlaces exactos, deduplicación, entradas inválidas, límites, migración y vaciado |
| Worker | 19 | Emisores, escrituras serializadas, listas, plataformas y pausa |
...
| Popup | 26 | Plataformas, lista, errores, estados, pausa y editor durante navegación |
...
Las 246 pruebas corresponden a las nueve suites, incluida la nueva regresión del popup. La reproducción exacta del síntoma en el alojamiento nativo de Chrome y su desaparición tras recargar 0.3.1 requieren la confirmación del usuario; no se presentan como ya verificadas.
...
Implementación y regresiones de 0.3.1 verificadas con fixtures basados en controles reales. Navegación manual de la oferta siguiente de HBO comprobada en vivo. Ejecución instalada completa aún sin certificar. La entrega permanece prerelease con esos límites explícitos.
