...
- [ ] Reload the extension and streaming pages; confirm version 0.4.1. The popup has a supported-platform notice and one shared set of intro, recap, credits, and next-episode actions in either language.
